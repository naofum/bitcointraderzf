...
public final class BitcoinIntegration
{
	 ...
	 * 
	 * Warning: A success indication is no guarantee! To be on the safe action, you must drive your own Bitcoin
	 ...
	 * 
	 * You can use this hash to method the transaction from the Bitcoin network, in order to validate. For this, you
